  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: center;"><img src="{{ site.url }}/assets/images/ModelCatalog.png" /><br />
        <a href="https://pluslib.readthedocs.io/projects/PlusModelCatalog/en/latest/index.html">Catalog of freely usable,<br />3D-printable models of tools and tracking fixtures</a>
      </td>
